...
- Alternativa para nota máxima: usar MediaPipe Face Landmarker (Tasks API) con modelos hospedados localmente (WASM/model packages). Si quieres puedo preparar esa versión.
